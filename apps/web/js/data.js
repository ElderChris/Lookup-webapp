...
/* =======================================================================
   LOOKUP — Logica applicativa e dati mock
   ----------------------------------------------------
...
export const SAMPLE_USERS = [
  ...
  { id: 11, username: 'admin', display_name: 'Amministratore',
    account_type: 'person',
    email: 'admin@lookup.local', city: 'Napoli',
...
export const SAMPLE_REVIEWS = [
  ...
  { id: 5,  target_user_id: 1, reviewer_id: 3, rating: 5,
    text: 'Volume restituito in tempo, conversazioni interessanti al passaggio. Una di quelle persone che ti fa amare di più Lookup.',
